...
const Tractor_EV = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await axios.get("/api/tractor-ev"); // Replace with real endpoint
    ...
    <div className="container-fluid px-md-5">
      <div className="row mb-4">
        <div className="col text-center">
          <h4 style={{ color: "#59bea0" }}>Tractor EV Electric Share Comparison</h4>
        </div>
      </div>
