...
function TwoThreeIcon(props: React.SVGProps<SVGSVGElement> & { color: string }) {
...
export default function IndustryCategoriesRow() {
  ...
  const softBorder = "ring-1 ring-inset ring-[#2F3949]/40 hover:ring-[#2F3949]/55";
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-4xl text-base md:text-lg leading-relaxed text-white/70">
            Comprehensive coverage across major automotive segments with detailed market
                  ...
                  <div className="w-16 flex justify-center">
                    ...
                    >
                      {Icon === "TwoThree" ? (
                        ...
                        <Icon className="h-6 w-6" strokeWidth={2.1} style={{ color }} />
                      )}
                    </span>
                  </div>

                  {/* Center label */}
                  <div className="flex-1 text-center text-lg font-semibold">{name}</div>
        ...
        <div className="mt-24 text-center">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-white/70">
            Comprehensive ranking of top manufacturers and segment distribution analysis
          </p>
        </div>
      </div>
    </section>
