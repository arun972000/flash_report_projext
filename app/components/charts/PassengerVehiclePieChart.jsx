...
const PassengerVehicleOEM = () => {
  const [data, setData] = useState([]);
  const [dateKeys, setDateKeys] = useState([]);

  useEffect(() => {
    const fetchData = async () => {
      const res = await axios.get("/api/passenger-overall"); // Replace with real endpoint
    ...
    <div className="container-fluid px-md-5">
      <div className="row mb-4">
        <div className="col text-center">
          <h4 style={{ color: "#ffdc00" }}>PV Overall OEM Market Share Comparison</h4>
        </div>
      </div>
...
export default PassengerVehicleOEM;
